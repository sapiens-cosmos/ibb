...
func CmdCreateMockNft() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msgMattCollection1 := types.NewMsgCreateNft(clientCtx.GetFromAddress().String(), "Matt's Favorite Girl", clientCtx.GetFromAddress().String(), "https://thumbs.gfycat.com/GiddyEvilAmazondolphin-mobile.mp4", "Body Roll", "cosmos1dyr7rmmdxylt3vm62x7z74sdealtv9rpzpsjy0")
			...
			msgPokemonCollection1 := types.NewMsgCreateNft(clientCtx.GetFromAddress().String(), "I wanna be the very best", clientCtx.GetFromAddress().String(), "https://secure.img1-fg.wfcdn.com/im/02238154/compr-r85/8470/84707680/pokemon-pikachu-wall-decal.jpg", "Pika Pika", "cosmos1dyr7rmmdxylt3vm62x7z74sdealtv9rpzpsjy0")
