...
func NewMsgCreateOffer(creator string, denom string, amount int32, paybackAmount int32, paybackDuration int32, offerStartAt int64, nftId uint64, interest int32) *MsgCreateOffer {
