...
func NewMsgCreateClaim(creator string, blockHeight int32, asset string, amount int32, denom string) *MsgCreateClaim {
...
func NewMsgUpdateClaim(creator string, id uint64, blockHeight int32, asset string, amount int32, denom string) *MsgUpdateClaim {
